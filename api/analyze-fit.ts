...
THESIS: Sam is founder of PAICE.work PBC. 20+ years building curriculum, certification, media, and learning systems that move capability into practice. Building AI-enabled measurement and education infrastructure for human-AI collaboration. Best suited to head-of-function, senior lead, and builder/operator roles where AI education, content quality, curriculum systems, certification, and learning measurement become core infrastructure.

TARGET BAND (apply when scoring the verdict):
- In-band role types: Head of Content & Curriculum; AI education systems; curriculum production systems; certification and learning measurement; developer education; adaptive / interactive learning products; partner / ecosystem / technical-partner education; founding or 0-to-1 program roles for products Sam can credibly teach.
- JD positive signals (raise verdict): "content and curriculum", "education", "adaptive learning", "personalized learning", "content quality", "quality bar", "measurement", "certification", "developer education", "AI-assisted content", "0-to-1", "founding", "define the operating model", "ambiguity", "builder mindset", "high agency", "hands-on with AI tools", "stand up", "from scratch".
...
- Set verdict to "strong" only if the role is in-band per TARGET BAND above AND aligns with content/curriculum systems, AI education, certification design, adaptive learning, learning measurement, partner education, 0-to-1 program build, or governance-adjacent education work. Set "weak" if the JD centers mature large-department maintenance, scaled team scope management, production engineering ownership, ML research ownership, direct fundraising leadership, consumer growth, or specialty domains he hasn't worked in. "moderate" otherwise.
